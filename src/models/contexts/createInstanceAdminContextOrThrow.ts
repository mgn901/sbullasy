...
/**
 * 操作を行おうとしているユーザーが、インスタンスの管理者の所属ユーザーであることを確認し、それを示す情報を返す。
 * 確認できなかった場合は例外を発生させる。
 ...
 * @returns 操作を行おうとしているユーザーが、インスタンスの管理者の所属ユーザーであることを示す情報。
 * @throws 操作を行おうとしているユーザーが、インスタンスの管理者の所属ユーザーではなかった場合、{@linkcode NotInstanceAdminException}を発生させる。
 */
