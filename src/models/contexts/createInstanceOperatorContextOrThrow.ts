...
/**
 * 操作しようとしているユーザーが、インスタンスのオペレーターの所属ユーザーであることを確認し、それを示す情報を返す。
 * 確認できなかった場合は例外を発生させる。
 ...
 * @returns 操作しようとしているユーザーが、インスタンスのオペレーターの所属ユーザーであることを示す情報。
 * @throws 操作しようとしているユーザーが、インスタンスのオペレーターの所属ユーザーではなかった場合、{@linkcode NotInstanceOperatorException}を発生させる。
 */
