...
export type Filter<T extends object, U extends T> = {
...
export const extract =
  <T extends object, U extends T>(filter: Filter<T, U>): ((value: T) => value is Extract<T, U>) =>
  (value: T): value is Extract<T, U> =>
    Object.entries(filter).every(([key, operand]) => value[key] === operand);

export const exclude =
  <T extends object, U extends T>(filter: Filter<T, U>): ((value: T) => value is Exclude<T, U>) =>
