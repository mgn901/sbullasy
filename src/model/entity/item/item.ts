...
export type WithReferences<T extends Item> = T & {
...
export interface ItemRepository {
  getOneById<TId extends ItemId>(
    this: ItemRepository,
    id: TId,
  ): Promise<FromRepository<WithReferences<Item> & { readonly id: TId }> | undefined>;

  getManyWithReferences(
    this: ItemRepository,
    params: {
  ...
  ): Promise<readonly FromRepository<WithReferences<Item>>[] | readonly []>;
